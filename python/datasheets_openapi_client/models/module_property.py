...
class ModuleProperty(BaseModel):
    ...
    relevance: StrictStr = Field(...)
    __properties = ["issue", "relevance"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModuleProperty:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModuleProperty:
        """Create an instance of ModuleProperty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModuleProperty.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ModuleProperty) in the input: " + obj)

        _obj = ModuleProperty.parse_obj({
            "issue": obj.get("issue"),
