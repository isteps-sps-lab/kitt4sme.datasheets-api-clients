...
from datasheets_openapi_client.models.datasheet import Datasheet  # noqa: E501
...
class TestDatasheet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Datasheet:
        """Test Datasheet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Datasheet`
        """
        model = Datasheet()  # noqa: E501
        if include_optional:
            return Datasheet(
                ...
                module_properties = datasheets_openapi_client.models.module_properties.ModuleProperties(
                    management = [
                        datasheets_openapi_client.models.module_property.ModuleProperty(
                            issue = '', 
                            relevance = '', )
                        ], 
                    quality = [
